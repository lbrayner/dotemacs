...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (evil-smartparens smartparens auto-dim-other-buffers ace-window haskell-mode dracula-theme f ox-pandoc slime org htmlize ox-reveal org-plus-contrib org-edna evil-surround evil-leader evil))))
(custom-set-faces
